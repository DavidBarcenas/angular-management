...
export class init1621124970097 implements MigrationInterface {
    name = 'init1621124970097'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "customer" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "lastName" character varying(100) NOT NULL, "phone" character varying(50) NOT NULL, "createAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "updateAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "userId" integer, CONSTRAINT "REL_3f62b42ed23958b120c235f74d" UNIQUE ("userId"), CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "products_categories" ("product_id" integer NOT NULL, "categorie_id" integer NOT NULL, CONSTRAINT "PK_b30bdb1bc5fd8005eca99f78f88" PRIMARY KEY ("product_id", "categorie_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f2c76a4306a82c696d620f81f0" ON "products_categories" ("product_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_27fb4e345ec94b232d46aa8b22" ON "products_categories" ("categorie_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "products_categories" ADD CONSTRAINT "FK_27fb4e345ec94b232d46aa8b225" FOREIGN KEY ("categorie_id") REFERENCES "category"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "products_categories" DROP CONSTRAINT "FK_27fb4e345ec94b232d46aa8b225"`);
        ...
        await queryRunner.query(`DROP INDEX "IDX_27fb4e345ec94b232d46aa8b22"`);
